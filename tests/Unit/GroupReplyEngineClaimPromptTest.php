...
class GroupReplyEngineClaimPromptTest extends TestCase
{
    public function test_system_prompt_contains_claim_flow_rules()
    {
        $conversation = new Conversation();
        $conversation->id = 50000;
        ...
        $this->assertStringContainsString('CLAIM FLOW (ABSOLUTE LOCK)', $prompt);
        $this->assertStringContainsString('Immediately ask for the USER ID', $prompt);
        $this->assertStringContainsString('Do NOT ask for or request sensitive information', $prompt);
